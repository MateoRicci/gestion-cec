  ...
  childs: [
    ...
    },
    {
      ...
      childs: [
        ...
        {
          id: "dashboards.configuraciones.empleados",
          path: path(ROOT_DASHBOARDS, "/configuraciones/empleados"),
          type: "item",
          title: "Empleados",
          transKey: "nav.dashboards.configuraciones.empleados",
          icon: "dashboards.configuraciones.empleados",
        },
        {
          id: "dashboards.configuraciones.convenios",
          path: path(ROOT_DASHBOARDS, "/configuraciones/convenios"),
          type: "item",
          title: "Convenios",
          transKey: "nav.dashboards.configuraciones.convenios",
          icon: "dashboards.configuraciones.convenios",
        },
      ],
    },
  ],
